...
## PDF Merge (Local + GitHub Actions)

PDF chunks are generated by Apps Script and stored in Drive. The final merge can be done:
- **Locally** with the Python script
- **Automatically** with GitHub Actions

Full setup guide:
- `docs/PDF_MERGE_ACTION_SETUP.md`
